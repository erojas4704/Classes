...
describe("PATCH /users/:username", () => {
  test("works for user with access", async function () {
    const resp = await request(app)
      .patch(`/users/u1`)
      .send({
        firstName: "New",
  ...
  test("bad request if not admin", async function () {
    const resp = await request(app)
      .patch(`/users/u2`)
      .send({
        firstName: 42,
  ...
  test("works: user can set new password for themselves", async function () {
    const resp = await request(app)
      .patch(`/users/u1`)
      .send({
